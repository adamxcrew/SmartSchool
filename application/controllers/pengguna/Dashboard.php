...
class Dashboard extends CI_Controller
{
    ...
    public function index()
    {
        $this->load->model('Pengguna');
        $data = array(
            'data_pendaftar' => $this->Pengguna->get_pendaftar()->result(),
    ...
    public function rapor1()
    {
        $this->load->model('Pengguna');
        $data        = array(
            'datarapormapel' => $this->Pengguna->get_datarapormapel()->result(),
            'datarapor1' => $this->Pengguna->get_datarapor1()->result()
        );
        
        $this->load->view('_partials/header');
        $this->load->view('_partials/menu_user');
        $this->load->view('siswa/datarapor1', $data);
        $this->load->view('_partials/footer');
    }
    ...
    public function siswaelearning()
    {
          $this->load->model('Pengguna');
          ...
          $data = array(
              'dataelearningtugas' => $this->Pengguna->get_dataelearning()->result(),
              'datakelas'  => $this->Pengguna->get_rolekelas()->result()
          );
          
          $this->load->view('_partials/header');
          $this->load->view('_partials/menu_user');
          $this->load->view('siswa/elearningsiswa', $data);
          $this->load->view('_partials/footer');
    }
